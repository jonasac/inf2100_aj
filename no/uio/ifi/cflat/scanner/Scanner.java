...
public class Scanner {
    ...
    /** 
     *
     * Collects all characers that are to be interpreted as numbers, including char literals
     * Upper case characters will return the corresponding ascii value.
     *
     * @return A string that only consists of what should be interpreted as numbers according to our grammar.
     * TODO: Does it make sense for this to return a int rather than a string, (non reasearched thought)
     */
    ...
    /** 
     *
     * Collects all characters that are to be interpreted as symbols, relies on
     * isSymbol to determine wether the char is a symbol
     *
     * @return a string consisting of a symbol, this can be one or more character, aslong as they represent one symbol
     */
    ...
    /**
     *
     * Skips the Chargenerator ahead aslong as curC is a whitespace, except cases where we are within a simgle quoted comment
     */
    ...
    public static void readNext() {
        ...
        while (nextNextToken == null) {
            ...
            if (eofCounter < 5) {
                ...
                // TODO: according to precode this cant be commented out
     ...
     * @return true if the char could be part of a compund symbol, otherwise false
     */
    ...
    /**
     * Checks wether the character represents a number in the range 0 up to and including 9
     * @return boolean if it is a digit, otherwise false
     */
