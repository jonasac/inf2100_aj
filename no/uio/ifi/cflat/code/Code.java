...
public class Code {
    ...
    public static void genInstr(String lab, String instr, String arg, String comment) {
        if (generatingData) {
    ...
    public static void genVar(String name, boolean global, int nBytes, String comment) {
        if (!generatingData) {
